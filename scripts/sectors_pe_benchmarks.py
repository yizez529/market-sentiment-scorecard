...
PE_BENCHMARKS = {
    ...
    "power_grid":        {"mean": 22.0, "std": 4.0,  "note": "GEV/ETN/PWR 5Y avg ~22x"},
    "datacenter_reit":   {"mean": 35.0, "std": 8.0,  "note": "REIT FFO multiple，DLR/EQIX 主导"},
    ...
    # === 根 5: 国防航天 ===
    "defense_space":     {"mean": 22.0, "std": 4.0,  "note": "ITA 5Y avg ~22x"},
